...
export const I18N = {
  fr: {
    ...
    closedHint: 'Élargis tes préférences pour voir plus de joueurs — ou reviens demain, de nouveaux membres rejoindront le court.',
    widenFilters: 'Élargir mes préférences',
  ...
  en: {
    ...
    closedHint: 'Widen your preferences to see more players — or come back tomorrow, new members will join the court.',
    widenFilters: 'Widen my preferences',
  ...
  he: {
    ...
    refreshStack: '← חזרה',
    closedClub: 'אין עוד שחקנים כרגע.',
    closedHint: 'אפשר להרחיב את ההעדפות כדי לראות עוד שחקנים, או לחזור מחר — חברים חדשים מצטרפים כל הזמן.',
    widenFilters: 'להרחיב את ההעדפות',
...
export const QUIZ_QUESTIONS = [
  ...
  // autres chaînes he ajoutées cette session (cf. commits précédents). Les
  // 11 options 3 ci-dessous (id 4 à 14) sont retraduites suite à la
  // reformulation fr/en du même commit : l'ancien texte hébreu correspondait
  // encore à la formulation FRANÇAISE précédente, devenue incohérente avec
  // le fr/en désormais affiché à côté.
  ...
  { id: 4, type: 'tech',
    ...
    options: [
      ...
      { fr: 'Ça passe souvent, mais pas à tous les coups',                 en: 'It works often, but not every time',              he: 'לרוב זה עובד, אבל לא בכל פעם', value: 3.5 },
  ...
  { id: 5, type: 'tech',
    ...
    options: [
      ...
      { fr: 'Elle passe, mais je ne choisis pas où',                      en: "It lands, but I don't choose where",                     he: 'היא עוברת, אבל אני לא בוחר לאן',            value: 3.5 },
  ...
  { id: 6, type: 'tech',
    ...
    options: [
      ...
      { fr: "Je la remets, sans pouvoir en faire grand-chose",   en: 'I get it back, without doing much with it',  he: 'אני מחזיר אותה, בלי להצליח לעשות איתה הרבה',   value: 3.5 },
  ...
  { id: 7, type: 'tech',
    ...
    options: [
      ...
      { fr: 'Je la remets en jeu, mais je subis le point',       en: "I get it back in play, but I'm stuck defending the point",            he: 'אני מחזיר אותה למשחק, אבל נשאר בהגנה על הנקודה',        value: 3.5 },
  ...
  { id: 8, type: 'tech',
    ...
    options: [
      ...
      { fr: "Je la remets basse, mais je n'enchaîne pas derrière",   en: "I return it low, but I can't follow up after",      he: 'אני מחזיר אותו נמוך, אבל לא ממשיך אחריו',      value: 3.5 },
  ...
  { id: 9, type: 'tech',
    ...
    options: [
      ...
      { fr: "Souvent profond, mais je ne choisis pas où ça tombe",          en: "Often deep, but I don't choose where it lands", he: 'לרוב עמוק, אבל אני לא בוחר איפה הוא נופל',     value: 3.5 },
  ...
  { id: 10, type: 'tech',
    ...
    options: [
      ...
      { fr: 'Je tente le par 3, ça passe une fois sur deux',       en: 'I go for the par 3, it lands about half the time',      he: 'אני מנסה פר 3, זה מצליח בערך פעם בשתיים',           value: 3.5 },
  ...
  { id: 11, type: 'tech',
    ...
    options: [
      ...
      { fr: 'Je tente le par 4, ça passe une fois sur deux',       en: 'I go for the par 4, it lands about half the time',      he: 'אני מנסה פר 4, זה מצליח בערך פעם בשתיים',           value: 3.5 },
  ...
  { id: 12, type: 'tech',
    ...
    options: [
      ...
      { fr: "Je vois venir le coup, mais je bouge trop tard",      en: 'I see the shot coming, but I react too late',     he: 'אני רואה את המכה מגיעה, אבל זז מאוחר מדי',     value: 3.5 },
  ...
  { id: 13, type: 'tech',
    ...
    options: [
      ...
      { fr: "Je vise, mais ça ne part pas toujours où je veux",          en: "I aim, but it doesn't always go where I want",    he: 'אני מכוון, אבל זה לא תמיד הולך לאן שאני רוצה',         value: 3.5 },
  ...
  { id: 14, type: 'tech',
    ...
    options: [
      ...
      { fr: 'Je monte, mais pas toujours au bon moment',            en: 'I move up, but not always at the right time',              he: 'אני עולה קדימה, אבל לא תמיד בזמן הנכון',      value: 3.5 },
...
export const GLOSSARY = [
  ...
  {
    key: 'confidenceRate',
    term: { fr: 'taux de confiance', en: 'confidence rate', he: 'מדד אמינות' },
    def: {
      fr: "Chaque partenaire évalue ton niveau après un match. Quand son avis rejoint ton niveau déclaré, le taux monte ; quand il s'en écarte, il descend. Au-delà de 75 %, ton niveau passe en confirmé.",
      en: "Each partner rates your level after a match. When their assessment matches your declared level, the rate rises; when it diverges, it falls. Above 75%, your level becomes confirmed.",
      he: "כל שותף מעריך את הרמה שלך אחרי משחק. כשההערכה שלו תואמת את הרמה שהצהרת, המדד עולה; כשהיא שונה, הוא יורד. מעל 75%, הרמה שלך הופכת למאושרת.",
    },
  },
  {
    key: 'provisionalLevel',
    term: { fr: 'niveau provisoire', en: 'provisional level', he: 'רמה זמנית' },
    def: {
      fr: "Ton niveau ne peut pas encore changer : il faut au moins 5 matchs confirmés pour recueillir assez d'avis et que le changement soit fiable.",
      en: "Your level can't change yet: at least 5 confirmed matches are needed to gather enough feedback for a reliable change.",
      he: "הרמה שלך עדיין לא יכולה להשתנות: נדרשים לפחות 5 משחקים מאושרים כדי לאסוף מספיק מידע לשינוי אמין.",
    },
  },
  {
    key: 'tier',
    term: { fr: 'palier', en: 'tier', he: 'שלב' },
    def: {
      fr: "Un objectif hebdomadaire de séries de matchs. Le franchir demande de jouer régulièrement, pas seulement de bien jouer.",
      en: "A weekly match-streak goal. Reaching it takes playing regularly, not just playing well.",
      he: "יעד שבועי של רצף משחקים. להשיג אותו דורש לשחק באופן קבוע, לא רק לשחק טוב.",
    },
  },
];
